[![npm-version](https://img.shields.io/npm/v/@scorpion626/react-doc-viewer.svg)](https://www.npmjs.com/package/@scorpion626/react-doc-viewer)
[![npm-download](https://img.shields.io/npm/dt/@scorpion626/react-doc-viewer.svg)](https://www.npmjs.com/package/@scorpion626/react-doc-viewer)

# @scorpion626/react-doc-viewer
...
```bash
 npm i @scorpion626/react-doc-viewer
 # or
 yarn add @scorpion626/react-doc-viewer
```
...
```tsx
import DocViewer, { DocViewerRenderers } from "@scorpion626/react-doc-viewer";
...
```tsx
import DocViewer, { PDFRenderer, PNGRenderer } from "@scorpion626/react-doc-viewer";
...
import DocViewer from "@scorpion626/react-doc-viewer";
...
If you need to prevent the actual loading of the file by `@scorpion626/react-doc-viewer`.<br>
...
By default, `@scorpion626/react-doc-viewer` fetches document metadata through a `HEAD` request in order to guess its `Content-Type`.
...
```tsx
import DocViewer, { DocViewerRef } from "@scorpion626/react-doc-viewer";
